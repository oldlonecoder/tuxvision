...
#### The Master ( or Root ) namespace is '::<font color="#809020">tux</font>' to prevent name clashing with other API having the same class names. the name 'tux' maybe owned (which I would be very outraged if it is the case because the Tux shall be a public domain trade mark and free to be used in public entities), but it is not used for private or exclusive commercial by this project.
* Naming convention : snake_case, PascalCase for enum items, UPPERCASE for the macros
  -- that I try to keep and follow.
